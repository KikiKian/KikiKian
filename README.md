...
I am a "programmer" and student based in Seattle and my favourite languages are Python, C++, Go (golang), and Rust. Current Dev and Maintainer of [**Lipi**](https://github.com/KikiKian/lipi). You can also find [***Lipi on Codeberg***](https://codeberg.org/i-am-kiki/lipi).

I also post my major repos on [***Codeberg***](https://codeberg.org/i-am-kiki/).
